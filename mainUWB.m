...
%% Extract Mocap data
dataMocap = mocap_csv2struct('Mama_Agents_Take_003.csv')
...
[~, offset] = syncTime(spline.RigidBody002, dataIMU);

% Adjust the spline such that it is also synchronized with the IMU/UWB
% data.
spline.RigidBody002.knots = spline.RigidBody002.knots - offset;
...
[r_Ltag2z_b, r_Rtag2z_b, r_Ltag1z_b, r_Rtag1z_b] = ...
         extractKeypoints('Tag_Position_Calibration_Take001.csv',...
...
[bias_Ltag1z, bias_Rtag1z, bias_Ltag2z, bias_Rtag2z] = ...
    extractUwbBias(spline, dataUWB,...
