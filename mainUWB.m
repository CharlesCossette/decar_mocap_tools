...
% data.
splineMocap.RigidBody002.knots = splineMocap.RigidBody002.knots - offset;
...
[r_Ltag2z_b, r_Rtag2z_b, r_Ltag1z_b, r_Rtag1z_b] = ...
         mocap_getPointsInBodyFrame('Tag_Position_Calibration_Take001.csv',...
...
[bias_Ltag1z, bias_Rtag1z, bias_Ltag2z, bias_Rtag2z] = ...
    extractUwbBias(splineMocap, dataUWB,...
