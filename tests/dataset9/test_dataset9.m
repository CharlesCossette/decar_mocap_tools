...
clearvars -except import_results
% An example of how to use the Mocap tools.
r_imuz_b = mocap_getPointInBodyFrame('2020_08_04_180_calibration_trial7',...
                                     'RigidBody','Unlabeled4738')
dataMocap = mocap_csv2struct('2020_08_04_180_mocap_trial8.csv')
% TODO: 1) include in mocap_csv2struct?
for lv1=1:1:length(dataMocap.RigidBody.t)
    dataMocap.RigidBody.r_zw_a(:,lv1) = dataMocap.RigidBody.r_zw_a(:,lv1) + ...
                                           dataMocap.RigidBody.C_ba(:,:,lv1).'*r_imuz_b;
...
splineMocap = mocap_fitSpline(dataMocap,[],true)
dataIMU = IMU_csv2struct('2020_07_30_23_24_02_trial8_sensehat_180.csv')
...
options.grav = true;
options.start_index = 1;
r = rmfield(import_results,'scale_accel');
r = rmfield(r,'scale_gyro');
r = rmfield(r,'skew_accel');
r = rmfield(r,'skew_gyro');
[results, dataCalibrated] = calibrateImu(dataAligned,options,import_results)
